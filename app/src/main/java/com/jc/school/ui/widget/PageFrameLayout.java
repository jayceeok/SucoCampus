...
import com.jc.school.adapter.PageFragmentAdapter;
import com.jc.school.ui.activity.NewGuideActivity;
import com.jc.school.ui.fragment.PageFragment;
...
public class PageFrameLayout extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public void setUpViews(int layoutIds[], int dot_on, int dot_off) {
        ...
        setSelectVp(0);
        NewGuideActivity activity = (NewGuideActivity) getContext();

package com.jc.school.ui.widget;
...
import com.jc.school.adapter.SearchAdapter;
import com.jc.school.bean.SearchResult;
import com.jc.school.ui.activity.WebActivity;
import com.jc.school.utils.AnimationUtil;
...
public class MaterialSearchView extends FrameLayout {
    ...
    private void initStyle(AttributeSet attrs, int defStyleAttr) {
        ...
        if (a != null) {
            ...
            if (a.hasValue(R.styleable.MaterialSearchView_android_textColorHint)) {
                setHintTextColor(
                        a.getColor(
                                R.styleable.MaterialSearchView_android_textColorHint, 0
                        )
                );
            }
    ...
    private void initSearchView() {
        ...
        mSearchSrcTextView.addTextChangedListener(
                new TextWatcher() {
                    @Override
        ...
        mSearchSrcTextView.setOnFocusChangeListener(

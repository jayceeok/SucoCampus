 ...
 *******************************************************************************/
package com.jc.pulltorefresh.library;
...
import com.jc.pulltorefresh.R;
import com.jc.pulltorefresh.internal.EmptyViewMethodAccessor;
import com.jc.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends
    ...
    public final void onScroll(final AbsListView view, final int firstVisibleItem,
        ...
        if (DEBUG) {
            Log.d(
                    LOG_TAG,
                    "First Visible: " + firstVisibleItem + ". Visible Count: " + visibleItemCount + ". Total Items:" + totalItemCount
            );
        }
    ...
    protected void handleStyledAttributes(TypedArray a) {
        ...
        mShowIndicator = a.getBoolean(
                R.styleable.PullToRefresh_ptrShowIndicator, !isPullToRefreshOverScrollEnabled()
        );
    }
    ...
    private boolean isLastItemVisible() {
        ...
        if (null == adapter || adapter.isEmpty()) {
            ...
            if (DEBUG) {
                Log.d(
                        LOG_TAG,
                        "isLastItemVisible. Last Item Position: " + lastItemPosition + " Last Visible Pos: " + lastVisiblePosition
                );
            }
